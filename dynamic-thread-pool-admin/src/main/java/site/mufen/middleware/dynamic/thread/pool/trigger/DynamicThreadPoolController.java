package site.mufen.middleware.dynamic.thread.pool.trigger;
...
import site.mufen.middleware.dynamic.thread.pool.types.Response;
...
public class DynamicThreadPoolController {
    ...
    public Response<ThreadPoolConfigEntity> queryThreadPoolConfig(@RequestParam String appName, @RequestParam String threadPoolName) {
        try {
            String cacheKey = "THREAD_POOL_CONFIG_PARAM_LIST_KEY" + "_" + appName + "_" + threadPoolName;
    ...
    public Response<Boolean> updateThreadPoolConfig(@RequestBody ThreadPoolConfigEntity request) {
        try {
            ...
            RTopic topic = redissonClient.getTopic("DYNAMIC_THREAD_POLL_REDIS_TOPIC" + "_" + request.getAppName());
